...
export function IconVenta({ className }: IconProps) {
  return (
    <svg
      className={className}
      width="18"
...
export function IconProduccion({ className }: IconProps) {
  return (
    <svg
      className={className}
      width="18"
      ...
      strokeLinejoin="round"
    >
      <path d="M12 3c1 3-2 4-2 7a4 4 0 0 0 8 0c0-2-1-3-2-5 0 2-1 2-2 1 0-1 0-2-2-3z" />
    </svg>
  );
}
